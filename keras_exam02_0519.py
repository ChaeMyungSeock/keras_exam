...
def split_xy2(dataset, time_step, y_column): # y칼럼을 2개씩 잘라서 사용
    x,y = list(), list()
...
x,y = split_xy2(dataset,time_step,2)
...
# 사실 차원을 읽으면 (면, 행, 열)로 읽어야 하지만 keras api상으로 마지막 것은 열이 아니라 feature이다.
